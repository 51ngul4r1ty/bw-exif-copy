...
//         assertEquals(actual[0].startIdx, 0);
//         assertEquals(actual[0].endIdx, 999);
//         assertEquals(actual[0].used, false);
//         assertEquals(actual[0].tags, new Set<string>(["init"]));
//     },
// });
...
//         assertEquals(actual[0].startIdx, 0);
//         assertEquals(actual[0].endIdx, 999);
//         assertEquals(actual[0].used, true);
//         assertEquals(actual[0].tags, new Set<string>(["init", "test"]));
//     },
// });
