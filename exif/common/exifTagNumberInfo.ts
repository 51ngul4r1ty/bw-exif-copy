// interfaces/types
import { TagGroup, TagNumberInfoItem } from "../types/exifTagNumberTypes.ts";
import { ExifDisplayValueStyle } from "../utils/exifDisplayUtils.ts";
import { ExifGpsCoordinateRef, ExifTableData } from "../exifBufferUtils/exifFormatTypes.ts";

// consts/enums
import * as tagNumberConstants from "./exifTagNumberConstants.ts";
...
} from "../utils/exifTagValueConverters.ts";
import {
    ...
    formatString,
    formatWhiteBalance
} from "../utils/exifTagValueFormatters.ts";
import { ConverterArgs } from "./exifTagNumberUtils.ts";
...
export const TAG_NUMBER_INFO: { [tagNumber: number]: TagNumberInfoItem } = {
    ...
    // TAG_NUMBER_INFO[tagNumberConstants.EXIF_EXPOSURE_TIME] = {name: "ExposureTime", format: "unsigned rational", compoNo: 1, desc: "Exposure time (reciprocal of shutter speed). Unit is second." };
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_OFFSET_TAG_NUMBER] = {
    name: "ExifOffset",
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_IMAGE_WIDTH] = {
    name: "ImageWidth",
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_IMAGE_LENGTH] = {
    name: "ImageLength",
    format: "unsigned short",
    compoNo: 1,
    desc: "Image length",
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_IMAGE_DESCRIPTION_TAG_NUMBER] = {
    name: "ImageDescription",
    format: "ascii string",
    compoNo: null,
    desc: "Describes image"
};
TAG_NUMBER_INFO[tagNumberConstants.EXIF_DEVICE_MAKE_TAG_NUMBER] = {
    name: "Make",
    format: "ascii string",
    compoNo: null,
    desc: "Shows manufacturer of digicam"
};
TAG_NUMBER_INFO[tagNumberConstants.EXIF_DEVICE_MODEL_TAG_NUMBER] = {
    name: "Model",
    format: "ascii string",
    compoNo: null,
    desc: "Shows model number of digicam"
};
TAG_NUMBER_INFO[tagNumberConstants.EXIF_IMAGE_ORIENTATION_TAG_NUMBER] = {
    name: "Orientation",
    format: "unsigned short",
    compoNo: 1,
    desc:
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_IMAGE_XRESOLUTION_TAG_NUMBER] = {
    name: "XResolution",
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_IMAGE_YRESOLUTION_TAG_NUMBER] = {
    name: "YResolution",
    format: "unsigned rational",
    compoNo: 1,
    desc: null
};
TAG_NUMBER_INFO[tagNumberConstants.EXIF_IMAGE_RESOLUTION_UNIT] = {
    name: "ResolutionUnit",
    format: "unsigned short",
    compoNo: 1,
    desc: "Unit of XResolution(0x011a)/YResolution(0x011b). '1' means no-unit, '2' means inch, '3' means centimeter."
};
TAG_NUMBER_INFO[tagNumberConstants.EXIF_DEVICE_SOFTWARE_TAG_NUMBER] = {
    name: "Software",
    format: "ascii string",
    compoNo: null,
    desc: "Shows firmware(internal software of digicam) version number."
};
TAG_NUMBER_INFO[tagNumberConstants.EXIF_DATE_DATETIME_TAG_NUMBER] = {
    name: "Date",
    format: "ascii string",
    compoNo: 20,
    desc:
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_IMAGE_WHITEPOINT_TAG_NUMBER] = {
    name: "WhitePoint",
    format: "unsigned rational",
    compoNo: 2,
    desc:
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_PRIMARY_CHROMATICITIES_TAG_NUMBER] = {
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_YCBCRCOEFFICIENTS_TAG_NUMBER] = {
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_YCBCRPOSITIONING_TAG_NUMBER] = {
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_REFERENCEBLACKWHITE_TAG_NUMBER] = {
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_COPYRIGHT_TAG_NUMBER] = {
    name: "Copyright",
    format: "ascii string",
    compoNo: null,
    desc: "Shows copyright information"
};
TAG_NUMBER_INFO[tagNumberConstants.EXIF_GPSINFO_TAG_NUMBER] = {
    name: "GPSInfo",
    format: "unsigned long",
    compoNo: 1,
    desc: null
};
TAG_NUMBER_INFO[tagNumberConstants.EXIF_GPSINFO_DIFFERENTIAL] = {
    name: "GPSDifferential",
    format: "unsigned short",
    compoNo: 1,
    desc: "Indicates whether differential correction is applied to the GPS receiver."
};
TAG_NUMBER_INFO[tagNumberConstants.EXIF_GPSINFO_VERSION] = {
    name: "GPSVersionID",
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_IMAGE_WIDTH_TAG_NUMBER] = {
    name: "ExifImageWidth",
    format: "unsigned short/long",
    compoNo: 1,
    desc: "Pixel width of main image"
};
TAG_NUMBER_INFO[tagNumberConstants.EXIF_IMAGE_HEIGHT_TAG_NUMBER] = {
    name: "ExifImageHeight",
    format: "unsigned short/long",
    compoNo: 1,
    desc: "Pixel height of main image"
};
TAG_NUMBER_INFO[tagNumberConstants.EXIF_EXPOSURE_TIME] = {
    name: "ExposureTime",
    format: "unsigned rational",
    compoNo: 1,
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_F_NUMBER] = {
    name: "FNumber",
    format: "unsigned rational",
    compoNo: 1,
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_IPTC_NAA] = {
    name: "IPTC/NAA",
    format: "undefined",
    compoNo: null,
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_EXPOSURE_PROGRAM] = {
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_ISO_SPEED_RATINGS] = {
    name: "ISOSpeedRatings",
    format: "unsigned short",
    compoNo: 2,
    desc: "CCD sensitivity equivalent to Ag-Hr film speedrate."
};
TAG_NUMBER_INFO[tagNumberConstants.EXIF_VERSION] = {
    name: "ExifVersion",
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_COMPRESSED_BITS_PER_PIXEL] = {
    name: "CompressedBitsPerPixel",
    format: "unsigned rational",
    compoNo: 1,
    desc: "The average compression ratio of JPEG."
};
TAG_NUMBER_INFO[tagNumberConstants.EXIF_SHUTTER_SPEED_VALUE] = {
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_APERTURE_VALUE] = {
    name: "ApertureValue",
    format: "unsigned rational",
    compoNo: 1,
    desc:
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_BRIGHTNESS_VALUE] = {
    name: "BrightnessValue",
    format: "signed rational",
    compoNo: 1,
    desc: "Brightness of taken subject, unit is EV."
};
TAG_NUMBER_INFO[tagNumberConstants.EXIF_EXPOSURE_BIAS_VALUE] = {
    name: "ExposureBiasValue",
    format: "signed rational",
    compoNo: 1,
    desc: "Exposure bias value of taking picture. Unit is EV."
};
TAG_NUMBER_INFO[tagNumberConstants.EXIF_MAX_APERTURE_VALUE] = {
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_SUBJECT_DISTANCE] = {
    name: "SubjectDistance",
    format: "signed rational",
    compoNo: 1,
    desc: "Distance to focus point, unit is meter."
};
TAG_NUMBER_INFO[tagNumberConstants.EXIF_METERING_MODE] = {
    name: "MeteringMode",
    format: "unsigned short",
    compoNo: 1,
    desc: "Exposure metering method. '1' means average, '2' center weighted average, '3' spot, '4' multi-spot, '5' multi-segment."
};
TAG_NUMBER_INFO[tagNumberConstants.EXIF_LIGHT_SOURCE] = {
    name: "LightSource",
    format: "unsigned short",
    compoNo: 1,
    desc:
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_FLASH] = {
    name: "Flash",
    format: "unsigned short",
    compoNo: 1,
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_FOCAL_LENGTH] = {
    name: "FocalLength",
    format: "unsigned rational",
    compoNo: 1,
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_MAKER_NOTE] = {
    name: "MakerNote",
    format: "undefined",
    compoNo: null,
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_USER_COMMENT] = {
    name: "UserComment",
    format: "ascii string", // was "undefined"
    compoNo: null,
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_FLASH_PIX_VERSION] = {
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_COLOR_SPACE] = {
    name: "ColorSpace",
    format: "unsigned short",
    compoNo: 1,
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_RELATED_SOUND_FILE] = {
    name: "RelatedSoundFile",
    format: "ascii string",
    compoNo: null,
    desc: "If this digicam can record audio data with image, shows name of audio data."
};
TAG_NUMBER_INFO[tagNumberConstants.EXIF_INTEROPERABILITY_OFFSET] = {
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_FOCAL_PLANE_X_RESOLUTION] = {
    name: "FocalPlaneXResolution",
    format: "unsigned rational",
    compoNo: 1,
    desc: "CCD's pixel density."
};
TAG_NUMBER_INFO[tagNumberConstants.EXIF_FOCAL_PLANE_Y_RESOLUTION] = {
    name: "FocalPlaneYResolution",
    format: "unsigned rational",
    compoNo: 1,
    desc: null
};
TAG_NUMBER_INFO[tagNumberConstants.EXIF_FOCAL_PLANE_RESOLUTIION_UNIT] = {
    name: "FocalPlaneResolutionUnit",
    format: "unsigned short",
    compoNo: 1,
    desc: "Unit of FocalPlaneXResoluton/FocalPlaneYResolution. '1' means no-unit, '2' inch, '3' centimeter."
};
TAG_NUMBER_INFO[tagNumberConstants.EXIF_SENSING_METHOD] = {
    name: "SensingMethod",
    format: "unsigned short",
    compoNo: 1,
    desc: "Shows type of image sensor unit. '2' means 1 chip color area sensor, most of all digicam use this type."
};
TAG_NUMBER_INFO[tagNumberConstants.EXIF_FILE_SOURCE] = {
    name: "FileSource",
    format: "unsigned byte", // was "undefined"
    compoNo: 1,
    desc:
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_SCENE_TYPE] = {
    name: "SceneType",
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_PHOTO_SENSITIVITY_TYPE] = {
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_CUSTOM_RENDERED] = {
    name: "CustomRendered",
    format: "unsigned short",
    compoNo: 1,
    desc:
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_EXPOSURE_MODE] = {
    name: "ExposureMode",
    format: "unsigned short",
    compoNo: 1,
    desc:
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_WHITE_BALANCE] = {
    name: "WhiteBalance",
    format: "unsigned short",
    compoNo: 1,
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_FOCAL_LENGTH_IN_35MM_FILM] = {
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_SCENE_CAPTURE_TYPE] = {
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_CONTRAST] = {
    name: "Contrast",
    format: "unsigned short",
    compoNo: 1,
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_SATURATION] = {
    name: "Saturation",
    format: "unsigned short",
    compoNo: 1,
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_SHARPNESS] = {
    name: "Sharpness",
    format: "unsigned short",
    compoNo: 1,
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_LENS_SPECIFICATION] = {
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_LENS_MODEL] = {
    name: "LensModel",
    format: "ascii string",
    compoNo: null,
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_PRINT_IMAGE_MATCHING] = {
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_GPS_ALTITUDE] = {
    name: "GPSAltitude",
    format: "unsigned rational",
    compoNo: 1,
    desc: ".",
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_GPS_ALTITUDE_REF] = {
    name: "GPSAltitudeRef",
    format: "unsigned byte",
    compoNo: 1,
    desc: ".",
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_GPS_DOP] = {
    name: "GPSDOP",
    format: "unsigned rational",
    compoNo: 1,
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_GPS_DATESTAMP] = {
    name: "GPSDateStamp",
    format: "ascii string",
    compoNo: 20,
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_GPS_LATITUDE] = {
    name: "GPSLatitude",
    format: "unsigned rational",
    compoNo: 3,
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_GPS_LATITUDE_REF] = {
    name: "GPSLatitudeRef",
    format: "ascii string",
    compoNo: 1,
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_GPS_LONGITUDE] = {
    name: "GPSLongitude",
    format: "unsigned rational",
    compoNo: 3,
    desc: "Indicates the latitude. The latitude is expressed as three RATIONAL values giving the degrees, minutes, and seconds, respectively. When degrees, minutes and seconds are expressed, the format is dd/1,mm/1,ss/1. When degrees and minutes are used and, for example, fractions of minutes are given up to two decimal places, the format is dd/1,mmmm/100,0/1.",
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_GPS_LONGITUDE_REF] = {
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_GPS_MEASURE_MODE] = {
    name: "GPSMeasureMode",
    format: "ascii string",
    compoNo: 1,
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_GPS_SPEED] = {
    name: "GPSSpeed",
    format: "unsigned rational",
    compoNo: 1,
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_GPS_SPEED_REF] = {
    name: "GPSSpeedRef",
    format: "ascii string",
    compoNo: 1,
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_GPS_TIME_STAMP] = {
    name: "GPSTimeStamp",
    format: "unsigned rational",
    compoNo: 3,
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_GPS_TRACK] = {
    name: "GPSTrack",
    format: "unsigned rational",
    compoNo: 1,
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_GPS_TRACK_REF] = {
    name: "GPSTrackRef",
    format: "ascii string",
    compoNo: 1,
...
TAG_NUMBER_INFO[tagNumberConstants.EXIF_GPSINFO_MAP_DATUM] = {
    name: "GPSMapDatum",
    format: "ascii string",
    compoNo: 1,
