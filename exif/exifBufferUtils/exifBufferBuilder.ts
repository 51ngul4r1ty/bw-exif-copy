// consts/enums
import { EXIF_PART_NAME_EXIF_FINAL_SPACER, EXIF_PART_NAME_GPS_IFD_BLOCK } from "../common/exifConstants.ts";
import {
...
} from "../common/exifTagNumberConstants.ts";
import { TAG_NUMBER_INFO } from "../common/exifTagNumberInfo.ts";

// interfaces/types
import { ExifDecodedPart, ExifDecodedPartType } from "../../types/exifBufferDecoderTypes.ts";
import { ExifRational, ExifTableData } from "../exifBufferUtils/exifFormatTypes.ts";
...
import { friendlyNameToFormat } from "../utils/exifFormatUtils.ts";
import {
    DegreesMinutesSeconds,
    floatToDegreesMinsSecs,
    floatToRational,
    /* GpsRef,*/ gpsRefToChar,
    GpsRefType
...
export const getIfdValuesStartOffset = (
    byteOrder: TiffByteOrder,
    entries: ImageFileDirectoryEntry[],
    ifdFirstByteOffset: number
): number => {
...
export const buildGpsInfoExifPart = (
    byteOrder: TiffByteOrder,
    latitude: number,
    longitude: number,
    ifdFirstByteOffset: number
