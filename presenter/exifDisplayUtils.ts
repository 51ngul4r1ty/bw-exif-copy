...
import {
    formatRational
} from "../jpeg/exifFormatUtils.ts";
import { getExifTableParentNode } from "../jpeg/tagNumberUtils.ts";
import { numberToHexString } from "../jpeg/hexUtils.ts";

// consts/enums
import * as tagNumbers from "../jpeg/tagNumbers.ts";
import { TagGroup } from "../jpeg/tagNumbers.ts";
...
function addTableRowFromTagNumberInfo(
    ...
    const tagNumberInfo = tagNumbers.TAG_NUMBER_INFO[tagNumber];
    if (!tagNumberInfo) {
        throw new Error(
